<template>
  <el-card>
    ...
    <div>
      <el-table :data="tableData" border stripe height="500px" :default-sort="{ prop: 'id', order: 'descending' }">
        <el-table-column v-for="col in dynamicCols" :key="col" :prop="col" :label="col" show-overflow-tooltip>
